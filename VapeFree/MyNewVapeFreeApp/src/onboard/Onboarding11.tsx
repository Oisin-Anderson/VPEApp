    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={{ flex: 1, justifyContent: 'center', width: '100%' }}>
          ...
          <MaskedView maskElement={<Text style={{ fontSize: scale(48), fontWeight: 'bold', textAlign: 'center' }}>€{yearlyCost.toFixed(2)}</Text>}>
            <LinearGradient
              colors={['#EF4444', '#3B82F6']}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
            >
              <Text style={{ fontSize: scale(48), fontWeight: 'bold', textAlign: 'center', opacity: 0 }}>€{yearlyCost.toFixed(2)}</Text>
            </LinearGradient>
          </MaskedView>
